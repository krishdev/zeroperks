...
const thankyouEmail = `<link crossorigin=anonymous href=https://use.fontawesome.com/releases/v5.3.1/css/all.css integrity=sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU rel=stylesheet><meta content=OBHSOz2bJypVuqhse4EbUNPh6u4nlzaqmKaLoOryaqs name=google-site-verification><style>@import url(https://fonts.googleapis.com/css?family=Dancing+Script|Open+Sans|Questrial&display=swap);body{background:#eaeaea;font-family:'Open Sans',sans-serif}.banner{background:#00f;color:#fff}.banner,.email-content{padding:2em 5em;overflow:hidden}h1{font-family:Questrial,sans-serif;font-size:5em;margin:0 0 .5em 0}hr{margin-top:2em;background:#00f}a{text-decoration:none}.sig{font-family:'Dancing Script',cursive;font-size:3.5em;margin:0}.email-container{margin:5% 25% 1% 25%;background:#fff}footer{text-align:center;margin:0;padding:1em}</style><main><div class=email-container><div class=email-body><div class=banner><h4>From Sabha & Krishna ❤️</h4><h1>We Feel <span>the Love</span></h1></div><div class=email-content><p>Hi there!<p>We wanted to say a <b>big thank you</b> for celebrating with us at our baby shower and gender reveal. Your presence added so much joy to our day, and we appreciate your warm wishes and thoughtful gifts. We can't wait for you to meet our little one!<p>Also please <b>share</b> all the event photos and videos to <b>mailkrishna2@gmail.com</b><hr><p>Sincerely,<p class=sig>Sabha & Krishna</div></div></div></main><footer><a href=https://www.zeroperks.com>www.zeroperks.com</a></footer>`;
