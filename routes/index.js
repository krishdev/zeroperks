...
router.post('/rsvp-event', async function (req, res) {
  ...
  try {
    ...
    if (!eventResBody || eventResBody.length === 0) {
        res.locals.message = "Event Not Found";
        res.locals.error = "Something went wrong while fetching event. Please try later.";
